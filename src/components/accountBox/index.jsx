      ...
      <BoxContainer>
        <TopContainer>
          ...
          {active === "signin" && (
            <>
              <HeaderContainer>
                <HeaderText>Лучше,</HeaderText>
                <HeaderText>Когда вы</HeaderText>
                <HeaderText>Авторизованы</HeaderText>
              </HeaderContainer>
              <SmallText>Войдите для продолжения</SmallText>
            </>
          )}
          {active === "signup" && (
            <>
              <HeaderContainer>
                <HeaderText>Создание </HeaderText>
                <HeaderText>Аккаунта</HeaderText>
              </HeaderContainer>
              <SmallText>Войдите для продолжения</SmallText>
            </>
          )}
