...
export function Services(props) {
  ...
  return (
    <ServicesContainer>
      <Title>Свежие объявления</Title>
      <ServicesWrapper>
        {isServicesEmpty && !isLoading && (
          <WarningText>Объявления закончились!</WarningText>
        )}
        {isLoading && <WarningText>Загрузка...</WarningText>}
        {!isServicesEmpty &&
          !isLoading &&
      ...
      <BottomContainer>
        {!isServicesEmpty && !isLoading && (
          <ViewMoreButton>Больше</ViewMoreButton>
        )}
      </BottomContainer>
    </ServicesContainer>
  );
